...
## ~~Phase 7 — Electron Auto-Update~~ ⏸️ Parked

> Moved to [`docs/workflow/projects/[parked]-auto-update/01-plan.md`](../[parked]-auto-update/01-plan.md). Blocked on Windows code signing. Full task specs (AU-1 code signing, AU-2 app implementation, AU-3 release pipeline) are preserved there in full fidelity.

---

### ~~V4-7.0 — Code signing setup~~ ⏸️ Parked — see parked project

### ~~V4-7.1 — Implement auto-update in the app~~ ⏸️ Parked — see parked project

### ~~V4-7.2 — Release pipeline: forge config + S3 publisher + `release.ts` script~~ ⏸️ Parked — see parked project
