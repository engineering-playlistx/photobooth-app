...
**File:** Find and test wherever email/phone/name validation lives (likely `apps/web/src/utils/` or inline in routes).
...
| Phase 1 — Unit: Business Logic | 🔜 Next | — | — |
| Phase 2 — API Route Tests | ⏳ Pending | — | — |
